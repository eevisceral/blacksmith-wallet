...
- Custom RPC must be tried before any public URL so a local fork cannot race onto live L1. If a custom RPC is set and fails, do not fall through to a public node.
